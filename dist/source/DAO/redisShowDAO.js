...
exports.redisShowDao = exports.RedisShowDao = void 0;
    ...
    saveAllByStation(station, shows) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to save shows:", error);
                throw error;
            }
        });
    }
    ...
    getAllByStation(station) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to get shows:", error);
                throw error;
            }
        });
    }
    ...
    getByIdAndStation(station, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to get show by id:", error);
                throw error;
            }
        });
    }
    ...
    getAllIdsByStation(station) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to get show IDs:", error);
                throw error;
            }
        });
    }
    ...
    deleteByIdAndStation(station, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to delete show:", error);
                throw error;
            }
        });
    }
    ...
    deleteAllByStation(station) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to delete all shows:", error);
                throw error;
            }
        });
    }
    ...
    existsByIdAndStation(station, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to check if show exists:", error);
                throw error;
            }
        });
    }
    ...
    countByStation(station) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisShowDao] Failed to count shows:", error);
                throw error;
            }
        });
    }
}
exports.RedisShowDao = RedisShowDao;
// Export singleton
exports.redisShowDao = new RedisShowDao();
//# sourceMappingURL=redisShowDAO.js.map