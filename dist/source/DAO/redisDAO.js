    ...
    saveAll(brands) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisDao] Failed to save brands:", error);
                throw error;
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!jsonData || typeof jsonData !== "string") {
                    console.log("[RedisDao] No brands found in Redis");
                    return null;
                }
                ...
                console.error("[RedisDao] Failed to get brands:", error);
                throw error;
            }
        });
    }
    ...
    getAllIds() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisDao] Failed to get brand IDs:", error);
                throw error;
            }
        });
    }
    ...
    deleteAll() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log("[RedisDao] Deleted all brands from Redis");
            }
            catch (error) {
                console.error("[RedisDao] Failed to delete all brands:", error);
                throw error;
            }
        });
    }
    ...
    count() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("[RedisDao] Failed to count brands:", error);
                throw error;
            }
        });
    }
