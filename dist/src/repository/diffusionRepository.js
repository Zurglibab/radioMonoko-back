...
const diffusionMapper_1 = require("../Mappers/diffusionMapper");
    ...
    fetchDiffusionsByStation(station_1, themes_1) {
        return __awaiter(this, arguments, void 0, function* (station, themes, first = 20) {
            ...
            try {
                ...
                const typedRoot = root;
                const edges = (_b = (_a = typedRoot === null || typedRoot === void 0 ? void 0 : typedRoot.diffusions) === null || _a === void 0 ? void 0 : _a.edges) !== null && _b !== void 0 ? _b : [];
                return edges
                    .map((edge) => edge === null || edge === void 0 ? void 0 : edge.node)
                    .filter((node) => !!node)
                    .map(diffusionMapper_1.toDiffusionDto);
            }
            catch (error) {
