...
exports.getDiffusionsByStation = getDiffusionsByStation;
const stationsEnum_1 = require("../Enums/stationsEnum");
const diffusionServices_1 = require("../Services/diffusionServices");
function getDiffusionsByStation(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        try {
            const { station } = req.params;
            const { first, themes, theme } = req.query;
            ...
            const diffusions = yield diffusionServices_1.diffusionApiService.getDiffusions(station, parsedThemes, parsedFirst);
            ...
            return res.status((_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.status) !== null && _b !== void 0 ? _b : 500).json({
                success: false,
                error: (_c = error === null || error === void 0 ? void 0 : error.message) !== null && _c !== void 0 ? _c : "Failed to fetch diffusions",
                details: (_e = (_d = error === null || error === void 0 ? void 0 : error.response) === null || _d === void 0 ? void 0 : _d.data) !== null && _e !== void 0 ? _e : null
            });
        }
    });
}
//# sourceMappingURL=diffusionController.js.map