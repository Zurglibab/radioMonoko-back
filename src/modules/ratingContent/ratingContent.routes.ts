...
import { RatingContentBDDRepository } from './ratingContent.bdd.repository';
import { RatingContentService } from './ratingContent.service';
import { RatingContentController } from './ratingContent.controller';

export const createRatingContentRouter = () => {
    const router = Router();
    const repository = new RatingContentBDDRepository();
